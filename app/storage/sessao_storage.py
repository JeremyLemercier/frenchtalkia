...
class SessaoStorage(BaseStorage[Sessao]):
    ...
    def criar_sessao_nova(self, id_usuario: str, estado_inicial: EstadoSessao = EstadoSessao.AGUARDANDO_NOME) -> Sessao:
        """
    ...
    def atualizar_selecoes(self, id_usuario: str, tema: str | None = None, 
                          topico: str | None = None, agent_id_mistral: str | None = None,
                          conversation_id_mistral: str | None = None) -> None:
        """
