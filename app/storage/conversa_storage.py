...
class ConversaStorage(BaseStorage[Conversa]):
    ...
    def criar_nova_conversa(self, id_usuario: str, tema: str, topico: str, 
                           conversation_id_mistral: str) -> Conversa:
        """
    ...
    def registrar_feedback(self, id_conversa: str, evaluation: int, comment: str | None = None) -> bool:
        """
    ...
    def obter_conversas_sem_feedback(self, id_usuario: str) -> list[Conversa]:
        ...
        conversas_usuario = self.obter_conversas_usuario(id_usuario)
        return [
            conversa for conversa in conversas_usuario 
