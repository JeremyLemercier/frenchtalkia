...
class MurfService:
    ...
    def gerar_audio(self, texto: str, voice_id: str = "fr-FR-adélie", style: str = "Conversational") -> tuple[Path, float]:
        """
    ...
    def gerar_audio_base64(self, texto: str, voice_id: str = "fr-FR-adélie", style: str = "Conversational") -> tuple[str, float]:
        """
