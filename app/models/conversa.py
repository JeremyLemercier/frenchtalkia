...
class Conversa(BaseModel):
    ...
    id_conversa: str = Field(default_factory=lambda: str(uuid4()), description="ID único da conversa")
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Conversa":
        ...
        if "data_fim" in data and data["data_fim"] is not None and isinstance(data["data_fim"], str):
